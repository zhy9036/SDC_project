...
class SDC_wall:
	...
	edge_dict = {'a':{'pins':[21, 20], 'speeds': [76, 115, 115, 75], 'timers': [3.3, 3.8, 1.5, 6]},
				 'b':{'pins':[16, 19], 'speeds': [77, 115, 115, 75], 'timers': [3.3, 3.3, 1.8, 6]},
				 'c':{'pins':[13, 6], 'speeds': [77, 115, 115, 76], 'timers': [3.1, 3.3, 0.8, 6]},
				 }
